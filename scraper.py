...
for opinion in opinions:
    ...
    single_opinion = {
        ...
        "cons": [cons.text.strip() for cons in opinion.select("div.review-feature__col:has(> review-feature__title--negatives)> div.review-feature__item")],
        "pros": [pros.text.strip() for pros in opinion.select("div.review-feature__col:has(> review-feature__title--positives)> div.review-feature__item ")],
    }
